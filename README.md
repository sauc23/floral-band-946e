...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-band-946e
```

A live public deployment of this template is available at [https://floral-band-946e.templates.workers.dev](https://floral-band-946e.templates.workers.dev)
